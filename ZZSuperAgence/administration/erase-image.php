...
//urldecode ou htmlspecialchars, preference pour htmlspecialchars
$id = htmlspecialchars($_GET['id']);

//recup des images en bdd
$req=$bdd->prepare('SELECT id, intitule, nom, description FROM image WHERE id = :id');
...
<body>
	...
	<main>
		...
		<br><br>
		<h1>Confirmation effacer image ?</h1>
		<br>
		<div class="container-fluid">
			<div class="row">
     			<form method="post" action="erase-image-list.php">
